...
namespace Drupal\emk_ckeditor\Plugin\CKEditorPlugin;
...
class CkeditorTemplates extends CKEditorPluginBase implements CKEditorPluginConfigurableInterface, ContainerFactoryPluginInterface
{
  ...
  {
    return ['emk_ckeditor/ckeditor.templates.dialog'];
  }
  ...
  public function settingsForm (array $form, FormStateInterface $form_state, Editor $editor)
  {
    ...
    $form['template_path'] = [
      ...
      '#description'   => t('Path to the javascript file defining the templates, relative to drupal root (starting with "/"). By default, it looks in your default theme directory for a file named "templates/emk_ckeditor.js"'),
    ];
    ...
    $form['#attached']['library'][] = 'emk_ckeditor/ckeditor.templates.admin';
  ...
  private function getTemplatesDefaultPath ()
  {
    ...
    $defaultPath = '/' . drupal_get_path('module', 'emk_ckeditor') . '/templates/example.js';
